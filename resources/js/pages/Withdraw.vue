                ...
                <div>
                    <div class="row">
                        ...
                        <div class="col-md-4 text-center">
                            <h1 class="text-h4 font-weight-black">Saque</h1>
                            <h1 class="text-h5 font-black" style="margin-top: 20px; margin-bottom: 5px">
                                Escolha o valor do seu saque:
                            </h1>
                            <form method="post" @submit.prevent="subValue">
                                <input type="number" step="0.01" min="0.01"
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-grey-darker"
                                    id="withdraw_value" v-model="form.withdraw_value" required />
...
export default {
    setup() {
        ...
        const subValue = async () => {
            try {
                const result = await axios.post('/api/account/withdraw', form);
                router.push('main')
            } catch (e) {
